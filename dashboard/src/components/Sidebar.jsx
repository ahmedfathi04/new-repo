...
const SIDEBAR_ITEMS =[
    ...
    { name: "Products", icon: ShoppingBag, color: "#88bcf9", href: "/products" },
    { name: "Users", icon: Users, color: "#fe4899", href: "/users" },
    { name: "Shared", icon: DollarSign, color: "#10b981", href: "/shared" },
    { name: "Orders", icon: ShoppingCart, color: "#f59e0b", href: "/orders" },
    { name: "Analytics", icon: TrendingUp, color: "#8b5cf6", href: "/analytics" },
    { name: "Settings", icon: Settings, color: "#6ef707", href: "/settings" }
]
const Sidebar = () => {
